...
- [ ] T167 [P] [US2.5] 先寫 AuthService.ValidateToken 測試於 MemberService/tests/MemberService.Application.Tests/Services/AuthServiceTests.cs
- [ ] T168 [P] [US2.5] 先寫 AuthController.Validate 整合測試於 MemberService/tests/MemberService.IntegrationTests/API/AuthControllerTests.cs

### DTOs

- [ ] T169 [P] [US2.5] 建立 TokenValidationResponse DTO 於 MemberService/src/MemberService.Application/DTOs/Auth/TokenValidationResponse.cs

### Services

- [ ] T170 [US2.5] 在 IAuthService 介面新增 ValidateTokenAsync 方法於 MemberService/src/MemberService.Application/Services/IAuthService.cs
- [ ] T171 [US2.5] 實作 AuthService.ValidateToken 方法於 MemberService/src/MemberService.Application/Services/AuthService.cs (依賴 T169, T170)

### Controllers

- [ ] T172 [US2.5] 實作 AuthController.Validate 端點於 MemberService/src/MemberService.API/Controllers/AuthController.cs (依賴 T171)

### 驗證

- [ ] T173 [US2.5] 執行所有 US2.5 測試並確保通過 (覆蓋率 >80%)
- [ ] T174 [US2.5] 手動測試 Token 驗證流程
- [ ] T175 [US2.5] 驗證錯誤處理：過期 Token、無效 Token
